...
def configs():
    ...
    parser.add_argument('--perforamnce_dir', type=str, default='/kaggle/working/MAUTrain/results/mau/')
    parser.add_argument('--save_dir', type=str, default='/kaggle/working/MAUTrain/checkpoints/mau/')
    parser.add_argument('--gen_frm_dir', type=str, default='/kaggle/working/MAUTrain/results/mau/')
